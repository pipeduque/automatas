...
public class LRButtonListener implements ActionListener {

	private ControlAutomaton controlAutomaton;
	private BackgroundPanel backgroundPanel;
	private int NroAutomaton;

	public LRButtonListener(ControlAutomaton controlAutomaton, BackgroundPanel backgroundPanel, int NroAutomaton) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (controlAutomaton.reverse(NroAutomaton)) {
